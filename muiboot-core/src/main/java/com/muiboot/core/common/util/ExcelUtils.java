...
import com.muiboot.core.common.util.poi.convert.ExportConvert;
import com.muiboot.core.common.util.poi.pojo.ExportItem;
import com.muiboot.core.common.annotation.ExportConfig;
import com.muiboot.core.common.util.handler.ExportHandler;
...
public class ExcelUtils {
	...
	private void required$BuilderParams() {
		if (mClass == null) {
			throw new IllegalArgumentException("请先使用com.muiboot.util.ExcelUtils.$Builder(Class<?>)构造器初始化参数。");
		}
	}
	...
	private void required$ExportParams() {
		if (mClass == null || mResponse == null) {
			throw new IllegalArgumentException(
					"请先使用com.muiboot.util.ExcelUtils.$Export(Class<?>, HttpServletResponse)构造器初始化参数。");
		}
